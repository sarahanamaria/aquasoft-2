...
const getByName = async (req, res) => {
  try {
    ...
    }); // search for document with the same name as the name we put in the parameter in the url. ex: /getProjectByName/doi will return the document which has the project_no = 'doi'
